...
export type BondPriceChangedEvent = TypedEvent<
  [BigNumber, BigNumber] & { internalPrice: BigNumber; debtRatio: BigNumber }
>;
...
export class RequiemCVXBondDepository extends BaseContract {
  ...
  interface: RequiemCVXBondDepositoryInterface;
