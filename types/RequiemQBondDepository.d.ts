...
interface RequiemQBondDepositoryInterface extends ethers.utils.Interface {
  functions: {
...
export class RequiemQBondDepository extends BaseContract {
  ...
  interface: RequiemQBondDepositoryInterface;
