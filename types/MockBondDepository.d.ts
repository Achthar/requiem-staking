...
interface MockBondDepositoryInterface extends ethers.utils.Interface {
  functions: {
...
export class MockBondDepository extends BaseContract {
  ...
  interface: MockBondDepositoryInterface;
