...
interface RequiemFundDistributorInterface extends ethers.utils.Interface {
  functions: {
    "addRequester(address)": FunctionFragment;
    "distributeTo(address,uint256,uint256)": FunctionFragment;
    ...
    "rewardGovernance()": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "rewardGovernance",
    values?: undefined
  ): string;
  encodeFunctionData(
...
export class RequiemFundDistributor extends BaseContract {
  ...
  interface: RequiemFundDistributorInterface;
  ...
  functions: {
    ...
    rewardGovernance(overrides?: CallOverrides): Promise<[string]>;
  ...
  estimateGas: {
    ...
    rewardGovernance(overrides?: CallOverrides): Promise<BigNumber>;
  ...
  populateTransaction: {
    ...
    rewardGovernance(overrides?: CallOverrides): Promise<PopulatedTransaction>;
