...
interface IRequiemWeightedPairFactoryInterface extends ethers.utils.Interface {
  functions: {
...
export class IRequiemWeightedPairFactory extends BaseContract {
  ...
  interface: IRequiemWeightedPairFactoryInterface;
