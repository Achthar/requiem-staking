...
interface TimelockInterface extends ethers.utils.Interface {
  ...
  events: {
    ...
    "NewProposerAdded(address)": EventFragment;
  ...
  getEvent(nameOrSignatureOrTopic: "NewProposerAdded"): EventFragment;
...
export type NewProposerAddedEvent = TypedEvent<[string] & { proposer: string }>;
...
export class Timelock extends BaseContract {
  ...
  callStatic: {
    ...
    addProposer(_propopser: string, overrides?: CallOverrides): Promise<void>;
  ...
  filters: {
    ...
    "NewProposerAdded(address)"(
      proposer?: string | null
    ): TypedEventFilter<[string], { proposer: string }>;
