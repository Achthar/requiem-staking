...
interface RequiemQBondStableDepositoryInterface extends ethers.utils.Interface {
  functions: {
...
export class RequiemQBondStableDepository extends BaseContract {
  ...
  interface: RequiemQBondStableDepositoryInterface;
