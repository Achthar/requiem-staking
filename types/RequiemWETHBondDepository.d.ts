...
interface RequiemWETHBondDepositoryInterface extends ethers.utils.Interface {
  functions: {
...
export class RequiemWETHBondDepository extends BaseContract {
  ...
  interface: RequiemWETHBondDepositoryInterface;
