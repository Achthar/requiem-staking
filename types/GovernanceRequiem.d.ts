...
interface GovernanceRequiemInterface extends ethers.utils.Interface {
  functions: {
    ...
    "increase_position(uint256,address,uint256)": FunctionFragment;
...
export class GovernanceRequiem extends BaseContract {
  ...
  interface: GovernanceRequiemInterface;
