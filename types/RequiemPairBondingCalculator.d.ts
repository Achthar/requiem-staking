...
interface RequiemPairBondingCalculatorInterface extends ethers.utils.Interface {
  functions: {
...
export class RequiemPairBondingCalculator extends BaseContract {
  ...
  interface: RequiemPairBondingCalculatorInterface;
