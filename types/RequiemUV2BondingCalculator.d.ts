...
interface RequiemUV2BondingCalculatorInterface extends ethers.utils.Interface {
  functions: {
...
export class RequiemUV2BondingCalculator extends BaseContract {
  ...
  interface: RequiemUV2BondingCalculatorInterface;
