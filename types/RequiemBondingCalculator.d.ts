...
interface RequiemBondingCalculatorInterface extends ethers.utils.Interface {
  functions: {
...
export class RequiemBondingCalculator extends BaseContract {
  ...
  interface: RequiemBondingCalculatorInterface;
