...
const func: DeployFunction = async function (hre: HardhatRuntimeEnvironment) {
	...
	const treasuryAddress = '0x2fD7c6a9466e20a91aBbb31849C081B8288030B2'
	const bondingDepositoryAddress = '0x95e7415e619d6D3ae4a140C23137DAaF3Acf7608'

	console.log("get treasury")
	const treasury = await ethers.getContractAt('RequiemTreasury', treasuryAddress);
	...
	const bondingDepository = await ethers.getContractAt('RequiemQBondDepository', bondingDepositoryAddress);
	...
	console.log("deposit LP amount", payoutInp.toString(), "at max price ", maxPrice)
...
export default func;
func.tags = ['treasury-follow-fuji'];
